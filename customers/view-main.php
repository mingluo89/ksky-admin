    ...
    <div class="px-3 py-3 py-lg-3">
        <div class="d-flex align-items-center">
            <span class="material-symbols-outlined text-white me-2">crown</span>
            <p class="text-white fw-bold my-3 text-20">Khách Hàng</p>
        </div>
    </div>
    <div class="bg-white vh-100">
        <div class="row mx-0">
            <div class="col-12 mt-3" style="padding-bottom: 80px;">
                ...
                ?>
                    <a href="/customers">
                        <div class="d-flex mb-3">
                            ...
                            <p class="text-12 text-primary">Tất cả khách hàng</p>
                        </div>
                    </a>
                <?php
                }
                ?>
                <form action="/customers" method="get" class="my-2">
                ...
                <?php
                $sql1 = "SELECT DISTINCT company_name FROM xuat";
                if (isset($_GET['search'])) {
                    $search = mysqli_escape_string($connect, $_GET['search']);
                    $sql1_search_part = " WHERE company_name LIKE '%$search%'";
                } else {
                    $sql1_search_part = "";
                }
                ...
                if ($count1 == 0) {
                ?>
                    <p class="text-12 my-3">0 khách hàng</p>
                <?php
                } else {
                ?>
                    <p class="text-12 mb-2 text-primary text-center"><?= $count1; ?> khách hàng</p>
                    <div class="table-responsive">
                        <table class="table table-sm table-bordered table-hovered bg-white">
                            <thead class="table-secondary">
                                ...
                                <th>
                                    <p class="text-10 fw-bold">Tên khách hàng</p>
                                </th>
                                <th>
                            ...
                            <tbody>
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <?php
                                        $sql_bill = "SELECT COUNT(id) as count, SUM(total_before_vat) as value FROM xuat WHERE company_name = '" . $row1['company_name'] . "'";
