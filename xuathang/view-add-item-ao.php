        ...
        <div class="col-12 col-md-8 offset-md-2 col-xl-6 offset-xl-3">
            <div class="d-flex align-items-center justify-content-between py-3">
                ...
                <div class="text-center">
                    <p class="fw-bold text-16">THÊM XUẤT DETAIL ẢO</p>
                </div>
                <div>
                </div>
            </div>
            ...
            <div class="rounded shadow-gg bg-white mb-3 p-3">
                <form action="/xuathang/do.php" method="post" id="addItemForm">
                    <input type="hidden" name="action" value="add-item-ao">
                    <input type="hidden" name="xuat_id" value="<?= $_GET['xuatid']; ?>">
                    <input type="hidden" name="product_id" id="productId" value="">
                    <input type="hidden" name="is_it_for" id="productId" value="<?= $_GET['isitfor']; ?>">
                    ...
                    <div id="suggestProduct" class="bg-grey p-3 rounded-20 mb-2" style="display:none">
                    ...
                    <!-- Unit, Qty, Price -->
                    <div class="d-flex align-items-start mb-2 bg-light rounded p-2 pb-0">
                        ...
                        <div class="container mb-3 px-0">
                            <div class="row">
                                ...
                                <div class="col-6 mb-2">
                                    <!-- Giá -->
                                    <label class="form-label mb-2" for="price">Giá nhập</label>
                    ...
                    <div class="d-grid">
                        <input type="submit" name="submit" class="btn btn-dark mt-2" value="Thêm">
                    </div>
                </form>
            </div>
        </div>
