...
?>
                ...
                <div class="col-12 col-md-8 offset-md-2 col-lg-6 offset-lg-3">
                    <div class="d-flex align-items-center justify-content-between p-3">
                        ...
                        <div class="d-flex align-items-center">
                            <p class="fw-bold text-14">SỬA ĐƠN XUẤT</p>
                        </div>
                        <div>
                        </div>
                    </div>
                    ...
                    <div class="px-3">
                        <div class="bg-white shadow-gg rounded p-3">
                            <form action="/xuathang/do.php" method="post">
                                <input type="hidden" name="action" value="edit-xuat">
                                <input type="hidden" name="xuat_id" value="<?= $row1['id']; ?>">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-8 col-md-9">
                                        <input type="text" class="form-control" id="accountingId" name="accounting_xuat_id" value="<?= $row1['accounting_xuat_id']; ?>" placeholder="Số hoá đơn VAT" required>
                                    </div>
                                </div>
    ...
    ?>
    <p class="text-center">Không tìm thấy đơn xuất ID #<?= $_GET['id']; ?></p>
<?php
}
?>