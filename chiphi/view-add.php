        ...
        <div class="col-12 col-md-8 offset-md-2 col-lg-6 offset-lg-3">
            <div class="d-flex align-items-center justify-content-between p-3">
                ...
                <div class="d-flex align-items-center">
                    <p class="fw-bold text-14">TẠO CHI PHÍ</p>
                </div>
                <div>
                </div>
            </div>
            ...
            <div class="px-3">
                <div class="bg-white shadow-gg rounded p-3">
                    <form action="/chiphi/do.php" method="post">
                        <input type="hidden" name="action" value="add-chiphi">
                        ...
                        <div class="d-flex align-items-center mb-4">
                            ...
                            <input type="text" class="form-control" id="accountingId" name="accounting_chiphi_id" value="" placeholder="Số hoá đơn VAT" required>
                        </div>
                        ...
                        <div class="d-flex align-items-center mb-4">
                            ...
                            <textarea class="form-control" id="companyInput" name="company_name" placeholder="Nhập để tìm" type="text" list="suppliers" required></textarea>
                        ...
                        <div class="d-flex align-items-center mb-4">
                            ...
                            <input type="number" class="form-control" id="total_before_vat" name="total_before_vat" value="" min="0" placeholder="" required>
                        </div>
                        ...
                        <div class="d-flex align-items-center mb-4">
                            <span class="material-symbols-outlined text-20 me-3 text-theme">functions</span>
                            <input type="number" class="form-control" id="total_after_vat" name="total_after_vat" value="" min="0" placeholder="" required>
                        </div>
                        ...
                        <div class="d-flex align-items-center mb-4">
                            ...
                            <input type="text" class="form-control" id="category" name="category" value="" placeholder="" required>
