...
$sql1 = "SELECT * FROM orders_detail WHERE id ='" . $_GET['itemid'] . "'";
        ...
        <div class="row">
            <div class="col-12 col-md-6 offset-md-3">
                <div class="d-flex align-items-center justify-content-between py-3">
                    <a href="./?view=detail&id=<?= $_GET['orderid']; ?>" class="btn ms-2"><span class="material-icons text-20">arrow_back_ios</span></a>
                    <div class="text-center">
                        <p class="text-16">Đơn hàng #<?= $_GET['orderid']; ?></p>
                        <p class="fw-bold text-20">Sửa item #<?= $_GET['itemid']; ?></p>
                    </div>
                    <div>
                    </div>
                </div>
            ...
            <div class="col-12 offset-md-2 col-md-8 offset-xl-3 col-xl-6">
                ...
                <div class="rounded shadow-gg bg-white p-3">
                    <form action="do.php" method="post">
                        ...
                        <input type="hidden" name="product_id" id="product_id" value="<?= $_GET['productid']; ?>">
                        ...
                        <div class="d-flex align-items-center mb-3">
                            ...
                            <input class="form-control" id="product_name" name="product_name" placeholder="Tìm tên, mã sản phẩm" type="search" value="<?= $_GET['productname']; ?>" required>
                        </div>
                        ...
                        <div style="<?= (isset($_GET['productid'])) ? "" : "display:none"; ?>">
                            <div class="row">
                                <div class="col-12">
                                    ...
                                    <!-- Chọn nhóm khách -->
                                    <label class="form-label mb-2" for="price">Chọn giá theo nhóm khách</label>
                                    <div id="groupRadio">
                                ...
                                <div class="col-6">
                                    ...
                                    <div class="d-flex align-items-center mb-3">
                                        ...
                                        <input type="number" class="form-control" min="0" step="1" name="price" id="price" value="<?= $price; ?>" required>
                                ...
                                <!-- SL -->
                                <div class="col-6">
                                    <label class="form-label mb-2" for="qty">Số Lượng</label>
                                    <div class="d-flex align-items-center mb-3">
                                        <span class="material-icons text-20 me-3 text-theme">123</span>
                                        <input type="number" class="form-control" min="0" name="qty" id="qty" value="<?= $qty; ?>" required>
                                    </div>
                                </div>

                                <!-- Thuế -->
                                <div class="col-6">
                                    <label class="form-label mb-2">Thuế suất</label>
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="tax_rate" id="taxRate1" value="0" data-tax="0" <?= ($tax_rate == 0) ? "checked" : ""; ?>>
                                        <label class="form-check-label" for="taxRate1">
                                            0%
                                        </label>
                                    </div>
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="tax_rate" id="taxRate2" value="5" data-tax="5" <?= ($tax_rate == 5) ? "checked" : ""; ?>>
                                        <label class="form-check-label" for="taxRate2">
                                            5%
                                        </label>
                                    </div>
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="tax_rate" id="taxRate3" value="8" data-tax="8" <?= ($tax_rate == 8) ? "checked" : ""; ?>>
                                        <label class="form-check-label" for="taxRate3">
                                            8%
                                        </label>
                                    </div>
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="tax_rate" id="taxRate4" value="10" data-tax="10" <?= ($tax_rate == 10) ? "checked" : ""; ?>>
                                ...
                                <div class="col-6">
                                    ...
                                    <div class="d-flex align-items-center mb-3">
                                        ...
                                        <p class="fw-bold text-success"><span id="total"><?= number_format($total, 0); ?></span> &#8363;</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="d-grid">
                            <input type="submit" name="submit" class="btn btn-theme mt-4 mb-3" value="Thêm">
                        </div>
                    </form>
                </div>
            </div>
