        ...
        <div class="col-12 col-md-8 offset-md-2 col-xl-6 offset-xl-3">
            <div class="d-flex align-items-center justify-content-between py-3">
                ...
                <div class="text-center">
                    <p class="fw-bold text-16">THÊM NHẬP DETAIL</p>
                </div>
                <div>
                </div>
            </div>
                ...
                <form action="/nhaphang/do.php" method="post" id="addItemForm">
                    ...
                    <div class="d-flex align-items-center mb-3">
                        ...
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="is_it" id="isit1" value="0" required>
                            <label class="form-check-label" for="isit1">Thật</label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="is_it" id="isit2" value="1" required>
                    ...
                    <div class="d-flex align-items-center mb-3">
                        ...
                        <input class="form-control" id="product_code" name="product_code" placeholder="Mã sản phẩm tự nhảy" type="search" readonly>
                    </div>
                        ...
                        <div class="container mb-3 px-0">
                            <div class="row">
                                ...
                                <div class="col-3 mb-2">
                                    ...
                                    <input type="text" class="form-control text-12" name="unit" id="unit" required>
                                </div>
