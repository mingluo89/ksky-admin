        ...
        <div class="col-12 col-md-8 offset-md-2 col-lg-6 offset-lg-3">
            <div class="d-flex align-items-center justify-content-between p-3">
                ...
                <div class="d-flex align-items-center">
                    <p class="fw-bold text-14">TẠO ĐƠN NHẬP</p>
                </div>
                <div>
                </div>
            </div>
            ...
            <div class="px-3">
                <div class="bg-white shadow-gg rounded p-3">
                    <form action="/nhaphang/do.php" method="post">
                        <input type="hidden" name="action" value="add-nhap">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-8 col-md-9">
                                <input type="text" class="form-control" id="accountingId" name="accounting_nhap_id" value="" placeholder="Số hoá đơn VAT" required>
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            <div class="col-4 col-md-3 col-form-label">
                                <div class="d-flex align-items-center">
                                    ...
                                    <label class="text-12" class="form-label mb-2" for="vatRate">%VAT</label>
                                </div>
                            </div>
                            <div class="col-8 col-md-9">
