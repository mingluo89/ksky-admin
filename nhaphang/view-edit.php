...
?>
                ...
                <div class="col-12 col-md-8 offset-md-2 col-lg-6 offset-lg-3">
                    <div class="d-flex align-items-center justify-content-between p-3">
                        ...
                        <div class="d-flex align-items-center">
                            <p class="fw-bold text-14">SỬA ĐƠN NHẬP</p>
                        </div>
                        <div>
                        </div>
                    </div>
                    ...
                    <div class="px-3">
                        <div class="bg-white shadow-gg rounded p-3">
                            <form action="/nhaphang/do.php" method="post">
                                <input type="hidden" name="action" value="edit-nhap">
                                <input type="hidden" name="nhap_id" value="<?= $row1['id']; ?>">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-8 col-md-9">
                                        <input type="date" class="form-control" id="accountingDate" name="accounting_date" value="<?= date("Y-m-d", strtotime($row1['accounting_date'])); ?>" required>
                                    </div>
                                </div>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-8 col-md-9">
                                        <input type="text" class="form-control" id="accountingId" name="accounting_nhap_id" value="<?= $row1['accounting_nhap_id']; ?>" placeholder="Số hoá đơn VAT" required>
                                    </div>
                                </div>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-8 col-md-9">
                                        <textarea class="form-control" id="companyInput" name="company_name" placeholder="Nhập để tìm" type="text" list="suppliers" rows="4" required><?= $row1['company_name']; ?></textarea>
                                ...
                                <div class="row mb-3">
                                    <div class="col-4 col-md-3 col-form-label">
                                        <div class="d-flex align-items-center">
                                            <!-- <span class="material-symbols-outlined text-20 me-3 text-theme">percent</span> -->
                                            <label class="text-12" for="vatRate">%VAT</label>
                                        </div>
                                    </div>
                                    <div class="col-8 col-md-9">
                                        <input type="number" class="form-control" id="vatRate" name="vat_rate" value="<?= $row1['vat_rate']; ?>" min="0" step="0.1" placeholder="chỉ nhập số. VD: VAT 10% nhập 10" required>
                                    </div>
                                </div>
    ...
    ?>
    <p class="text-center">Không tìm thấy đơn nhập ID #<?= $_GET['id']; ?></p>
<?php
}
?>